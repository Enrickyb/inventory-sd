...
const db = new sqlite3.Database('./inventory.db', (err) => {
    ...
    quantity INTEGER
        ...
        db.run(`INSERT OR IGNORE INTO books (id, title, quantity) VALUES (?, ?, ?)`, ['2', 'Node.js Guide', 10]);
        db.run(`INSERT OR IGNORE INTO books (id, title, quantity) VALUES (?, ?, ?)`, ['3', 'Web Development Basics', 8]);
...
server.listen(5000, '0.0.0.0', () => {
    console.log('Inventory Service running on 0.0.0.0:5000');
});